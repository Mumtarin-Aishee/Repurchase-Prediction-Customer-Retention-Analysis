...
*[View the interactive dashboard](https://htmlpreview.github.io/?https://github.com/<your-username>/<repo-name>/blob/main/phase-1-bi-repurchase-model/dashboard/repurchase-interval-dashboard.html)*
